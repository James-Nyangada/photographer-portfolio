      ...
      <div id="content" className="site-content">
        <div className="content-945 center-relative">
          ...
          <div className="two_third last">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iste omnis cupiditate excepturi perspiciatis. Quidem exercitationem dolore expedita? Dolor quam vel voluptas est repellendus quos delectus ipsa porro exercitationem saepe quisquam impedit nostrum, odit eaque omnis at reprehenderit sapiente debitis dignissimos?
          </div>
          ...
          <div className="one_third">
            <div className="info-code">
              ...
              <p className="info-code-content">+254.456.789.123</p>
            </div>
            <div className="info-code">
              <p className="info-code-title">Instagram</p>
              <p className="info-code-content">@jamess_xiv</p>
            </div>
            <div className="info-code">
              <p className="info-code-title">Email</p>
              <p className="info-code-content">jamesedwin03@gmail.com</p>
            </div>
          </div>
          {/* Contact Form */}
          <div className="two_third last">
